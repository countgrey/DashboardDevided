...
using DashboardDevided.Core.Models.Shop;
using DashboardDevided.Core.Services.Account;
using DashboardDevided.Server.ViewModels.Account;
using DashboardDevided.Server.ViewModels.Shop;
using Microsoft.AspNetCore.Identity;

namespace DashboardDevided.Server.Configuration
{
