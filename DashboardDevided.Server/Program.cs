...
using DashboardDevided.Core.Infrastructure;
using DashboardDevided.Core.Models.Account;
using DashboardDevided.Core.Services;
using DashboardDevided.Core.Services.Account;
using DashboardDevided.Core.Services.Shop;
using DashboardDevided.Server.Authorization;
using DashboardDevided.Server.Authorization.Requirements;
using DashboardDevided.Server.Configuration;
using DashboardDevided.Server.Services;
using DashboardDevided.Server.Services.Email;
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.DocumentTitle = "Swagger UI - DashboardDevided";
